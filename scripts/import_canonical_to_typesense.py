...
TYPESENSE_HOST = (
    "apollo.int.liesdonk.nl"  # For Typesense Cloud use xxx.a1.typesense.net
)
TYPESENSE_PORT = 8108  # For Typesense Cloud use 443
TYPESENSE_PROTOCOL = "http"  # For Typesense Cloud use https
TYPESENSE_API_KEY = "xyz"  # Default 'xyz'
            ...
            case "canonical_musicbrainz_data.csv":
                with TextIOWrapper(fo, encoding="utf-8") as tw:
                    try:
                        ...
                        if documents:
                            client.collections[TYPESENSE_COLLECTION].documents.import_(
                                documents
                            )
