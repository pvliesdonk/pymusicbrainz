...
seed = pymusicbrainz.datatypes.identifiers.RecordingID("2bb74cf7-acd5-4f7b-9be1-1c9eceb96a3d")
seed2 = pymusicbrainz.datatypes.identifiers.RecordingID("2bb74cf7-acd5-4f7b-9be1-1c9eceb96a3d")
eq = (seed == seed2)

sfdgdsfg = pymusicbrainz.search_song(seed_id=pymusicbrainz.datatypes.identifiers.RecordingID("2bb74cf7-acd5-4f7b-9be1-1c9eceb96a3d"))
...
i = pymusicbrainz.search_by_recording_id(
    pymusicbrainz.datatypes.identifiers.RecordingID("77601dfe-df14-4894-a8b7-c5c68ca25e11"))
